...
parsed_data as (
    select
        ...
        data->>'id'::varchar as tock_guest_id,
        data->'patron'->>'id'::varchar as patron_id,
        data->'patron'->>'email'::varchar as email,
        data->'patron'->>'firstName'::varchar as first_name,
        data->'patron'->>'lastName'::varchar as last_name,
        data->'patron'->>'phone'::varchar as phone,
        data->'patron'->>'phoneCountryCode'::varchar as phone_country_code,
        data->'patron'->>'zipCode'::varchar as zip_code,
        data->'patron'->>'isoCountryCode'::varchar as iso_country_code,
        data->'address'->>'country'::varchar as address_country,
        
        -- Extract phone array data
        jsonb_array_length(data->'phone') as phone_count,
        data->'phone'->0->>'phone'::varchar as primary_phone,
        data->'phone'->0->>'phoneCountryCode'::varchar as primary_phone_country_code,
        ...
        case 
            ...
            then data->'link'->0->>'type'::varchar 
            else null 
        end as primary_link_type,
        case 
            when jsonb_array_length(data->'link') > 0 
            then data->'link'->0->>'link'::varchar 
            else null 
        ...
        -- Extract aversions
        data->>'patronProfileAversions'::varchar as aversions,
        
        -- Business and metadata
        data->>'businessGroupId'::int as business_group_id,
        data->>'optInSource'::varchar as opt_in_source,
