...
select
    ...
    case
        when trim(concat(first_name, ' ', last_name)) = 'Admin Damaged' then '73700'
        when trim(concat(first_name, ' ', last_name)) = 'Admin Donations' then '70401'
        when trim(concat(first_name, ' ', last_name)) = 'Admin Employee Comp' then '83507'
        when trim(concat(first_name, ' ', last_name)) = 'Admin Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Admin Secondary Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Culinary Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Culinary Secondary Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Distribution Damaged' then '73700'
        when trim(concat(first_name, ' ', last_name)) = 'Distribution Donations' then '70401'
        when trim(concat(first_name, ' ', last_name)) = 'Distribution Employee Comp' then '83506'
        when trim(concat(first_name, ' ', last_name)) = 'Distribution Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Distribution Secondary Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Event Damaged' then '70801'
        when trim(concat(first_name, ' ', last_name)) = 'Event Donations' then '70401'
        when trim(concat(first_name, ' ', last_name)) = 'Event Employee Comp' then '83506'
        when trim(concat(first_name, ' ', last_name)) = 'Event Pours' then '54001'
        when trim(concat(first_name, ' ', last_name)) = 'Event Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Event Secondary Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Export Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Inbound Pours' then '54001'
        when trim(concat(first_name, ' ', last_name)) = 'Marketing Damaged' then '73700'
        when trim(concat(first_name, ' ', last_name)) = 'Marketing Donations' then '70401'
        when trim(concat(first_name, ' ', last_name)) = 'Marketing Employee Comp' then '83506'
        when trim(concat(first_name, ' ', last_name)) = 'Marketing Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Marketing Secondary Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Ownership Damaged' then '73700'
        when trim(concat(first_name, ' ', last_name)) = 'Ownership Donations' then '70401'
        when trim(concat(first_name, ' ', last_name)) = 'Ownership Employee Comp' then '83507'
        when trim(concat(first_name, ' ', last_name)) = 'Ownership Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Ownership Secondary Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Production Damaged' then '73700'
        when trim(concat(first_name, ' ', last_name)) = 'Production Donations' then '70401'
        when trim(concat(first_name, ' ', last_name)) = 'Production Employee Comp' then '83506'
        when trim(concat(first_name, ' ', last_name)) = 'Production Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Production Secondary Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Tasting Room Damaged' then '70801'
        when trim(concat(first_name, ' ', last_name)) = 'Tasting Room Donations' then '70401'
        when trim(concat(first_name, ' ', last_name)) = 'Tasting Room Employee Comp' then '83507'
        when trim(concat(first_name, ' ', last_name)) = 'Tasting Room Pours' then '54001'
        when trim(concat(first_name, ' ', last_name)) = 'Tasting Room Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Tasting Room Secondary Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Wine Club Damaged' then '73700'
        when trim(concat(first_name, ' ', last_name)) = 'Wine Club Donations' then '70401'
        when trim(concat(first_name, ' ', last_name)) = 'Wine Club Employee Comp' then '83507'
        when trim(concat(first_name, ' ', last_name)) = 'Wine Club Pours' then '54001'
        when trim(concat(first_name, ' ', last_name)) = 'Wine Club Samples' then '70001'
        when trim(concat(first_name, ' ', last_name)) = 'Wine Club Secondary Samples' then '70001'
        else null
    end as no_charge_gl
from base
